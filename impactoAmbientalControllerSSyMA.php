...
include 'impactoAmbientalModelSSyMA.php';
...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'POST':
        ...
        if(isset($arreglo['aspecto']) && isset($arreglo['unidad']) && isset($arreglo['clasificacion']) && isset($arreglo['ciclo']) && isset($arreglo['entradas_salidas'])
            && isset($arreglo['impacto']) && isset($arreglo['requisito']) && isset($arreglo['alcance']) && isset($arreglo['CO2']) && isset($arreglo['CH4']) 
            && isset($arreglo['NO2']) && isset($arreglo['CO2CO2e']) && isset($arreglo['CH4CO2e']) && isset($arreglo['N2OCO2e']) && isset($arreglo['e_s'])){

            $aspecto = $arreglo['aspecto'];
            $unidad = $arreglo['unidad'];
            $clasificacion = $arreglo['clasificacion'];
            $ciclo = $arreglo['ciclo'];
            $entradas_salidas = $arreglo['entradas_salidas'];
            ...
            $val [] = insertarImpactoAmbientalSSyMA($aspecto,$unidad,$clasificacion,$ciclo,$entradas_salidas,$impacto,$requisito,
    ...
    case 'PUT':
        // Manejar solicitud PUT (actualización)
            if(isset($arreglo['id']) && isset($arreglo['aspecto']) && isset($arreglo['unidad']) && isset($arreglo['clasificacion']) && isset($arreglo['ciclo']) 
                && isset($arreglo['entradas_salidas']) && isset($arreglo['impacto']) && isset($arreglo['requisito']) && isset($arreglo['alcance']) && isset($arreglo['CO2']) 
                && isset($arreglo['CH4']) && isset($arreglo['NO2']) && isset($arreglo['CO2CO2e']) && isset($arreglo['CH4CO2e']) && isset($arreglo['N2OCO2e']) && isset($arreglo['e_s'])){
                ...
                $val[]=actualizarImpactoAmbientalSSyMA($id,$aspecto,$unidad,$clasificacion,$ciclo,$entradas_salidas,$impacto,$requisito,
                $alcance,$CO2,$CH4,$NO2,$CO2CO2e,$CH4CO2e,$N2OCO2e,$e_s);
            }else{
    ...
    case 'DELETE':
        // Manejar solicitud DELETE (eliminación)
            if(isset($arreglo['id'])){
                $id = $arreglo['id'];
                $val[] = eliminarImpactoAmbientalSSyMA($id);
            } else {
